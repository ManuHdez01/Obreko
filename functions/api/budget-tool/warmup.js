// GET /api/budget-tool/warmup?return=<url>
//
...
export async function onRequestGet({ request }) {
  ...
  let ret = url.searchParams.get('return') || '/herramienta-presupuestos/';
  // Solo rutas relativas del propio sitio (evita open redirect).
  if (!ret.startsWith('/') || ret.startsWith('//')) ret = '/herramienta-presupuestos/';
