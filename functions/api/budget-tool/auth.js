// POST /api/budget-tool/auth — valida PIN y devuelve cookie de sesión
// DELETE /api/budget-tool/auth — cierra sesión
import { createSessionCookie, clearSessionCookie, verifySession } from './_auth.js';

export async function onRequestPost({ request, env }) {
  if (!env.BUDGET_TOOL_PIN || !env.BUDGET_TOOL_SESSION_SECRET) {
