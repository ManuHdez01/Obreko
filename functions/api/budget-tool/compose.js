      ...
      items: {
        ...
        items: {
          ...
          properties: {
            ...
            material: { type: 'number', description: 'Importe en euros de la parte de material de la partida, con céntimos si el texto los trae. Si el texto lo separa (columna "Material (€)"), cópialo tal cual; si no, estímalo. material + manoObra tiene que sumar el importe total de la partida.' },
            manoObra: { type: 'number', description: 'Importe en euros de la parte de mano de obra de la partida, con céntimos si el texto los trae. Si el texto lo separa (columna "Mano de obra (€)"), cópialo tal cual; si no, estímalo. Una demolición o un alicatado son casi toda mano de obra; un sanitario o un electrodoméstico, casi todo material.' },
            ...
            unitPrice: { type: 'number', description: 'Precio unitario en euros, sin impuestos. Si el texto trae céntimos (8,50 €), respétalos tal cual — no redondees al euro.' },
...
IMPORTANTE: respeta los céntimos tal y como vienen en el texto o Excel de origen: precios unitarios, material y mano de obra pueden llevar decimales (8,50 €, no 8 o 9 €) — no los redondees al euro. Cuadra el reparto para que material + manoObra sume el importe de la partida, con la misma precisión de céntimos. Las cantidades también pueden llevar decimales (49,16 m²).
